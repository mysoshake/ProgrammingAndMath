...
# TODO
## ペアノの公理から1+1=2を証明するためにもっと基本的なことを固める
### まずは論理学の「P∨￢P = T」
1. 数学的対象すべての親クラスMathObject作成 FIN<br>

2. 命題Propositionクラスを作成 <br>
2.1. 真偽クラスMathBooleanクラスを作成 <br>
2.2. 命題を評価Evaluateして真偽を返すようにする <br>

3. 論理評価クラスLogicを作成 <br>
3.1. まずは等式を受け取り <br>
3.2. 命題が正しいかどうかをチェックする <br>
